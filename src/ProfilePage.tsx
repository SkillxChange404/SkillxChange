...
const ProfilePage: React.FC = () => {
  ...
  // Fetch user data from an API (mocking it for now)
  useEffect(() => {
      ...
      <MDBContainer className="py-5">
        ...
        <MDBRow>
              ...
              <MDBCardBody className="p-0">
                <MDBListGroup flush className="rounded-3">
                  ...
                  <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                    ...
                    <MDBCardText>{profile.socialLinks.github}</MDBCardText>
                  </MDBListGroupItem>
                  <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                    <MDBIcon fab icon="twitter fa-lg" style={{ color: '#55acee' }} />
                    <MDBCardText>{profile.socialLinks.twitter}</MDBCardText>
                  </MDBListGroupItem>
                  <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                    <MDBIcon fab icon="instagram fa-lg" style={{ color: '#ac2bac' }} />
                    <MDBCardText>{profile.socialLinks.instagram}</MDBCardText>
                  </MDBListGroupItem>
                  <MDBListGroupItem className="d-flex justify-content-between align-items-center p-3">
                    <MDBIcon fab icon="facebook fa-lg" style={{ color: '#3b5998' }} />
                    <MDBCardText>{profile.socialLinks.facebook}</MDBCardText>
                  </MDBListGroupItem>
                </MDBListGroup>
              </MDBCardBody>
            </MDBCard>
          ...
          <MDBCol lg="8">
            ...
            {/* Add Project Status or additional sections as needed */}
          </MDBCol>
        </MDBRow>
      </MDBContainer>
    </section>
